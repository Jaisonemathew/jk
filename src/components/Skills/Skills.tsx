...
<div className="">
  <Fade>
<div className="lg:w-82 h-82 m-8 rounded-2xl p-8 flex flex-col justify-center items-center bg-newblack hover:text-nblack hover:bg-nwhite scale-on-hover">
...
<Fade>
<div className="">
  <img src={iosimage} alt="Image" className="mt-8 lg:h-83 lg:max-w-[518px] scale-on-hover md:hidden lg:block "></img>
</div>
</Fade>
